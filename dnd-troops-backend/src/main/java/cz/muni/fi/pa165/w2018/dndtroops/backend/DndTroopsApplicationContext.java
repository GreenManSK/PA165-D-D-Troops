package cz.muni.fi.pa165.w2018.dndtroops.backend;
...
/**
 * Application context for backend layer
 *
...
@ComponentScan(basePackageClasses = {Hero.class}, basePackages = "cz.muni.fi.pa165.w2018.dndtroops")
public class DndTroopsApplicationContext {
